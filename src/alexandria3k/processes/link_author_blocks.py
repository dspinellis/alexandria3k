...
def create_author_blocks_table(database_path):
    ...
    for id , given , family_name , work_id in select_cursor.execute("""
        ...
        (id , normalized_name , normalized_family , work_id ,block_key),
...
def process(database_path):
    """This process will create the name_block tables for every author in the database
       For each author in the database, his named will be passed through a name-normalisation algorithm, 
