...
CREATE TABLE works_venue AS
  ...
  CASE
    ...
    -- Index 7
    WHEN doi LIKE '10.1007/978-3-030-88106-1_%' THEN 'SSBSE'  -- 2021
    WHEN doi LIKE '10.1007/978-3-030-59762-7_%' THEN 'SSBSE'  -- 2020
    WHEN doi LIKE '10.1007/978-3-030-27455-9_%' THEN 'SSBSE'  -- 2019
    WHEN doi LIKE '10.1007/978-3-319-99241-9_%' THEN 'SSBSE'  -- 2018
    WHEN doi LIKE '10.1007/978-3-319-66299-2_%' THEN 'SSBSE'  -- 2017

    -- Index 8
    -- CSMR and WCRE are SANER from 2015 onward

    WHEN doi LIKE '10.1109/ICPC52881.2021.%' THEN 'ICPC'  -- 2021
    WHEN doi LIKE '10.1145/3387904.%' THEN 'ICPC'  -- 2020
    WHEN doi LIKE '10.1109/ICPC.2019.%' THEN 'ICPC'  -- 2019
    WHEN doi LIKE '10.1145/3196321.%' THEN 'ICPC'  -- 2018
    WHEN doi LIKE '10.1109/ICPC.2017.%' THEN 'ICPC'  -- 2017
    ...
    WHEN doi LIKE '10.1109/ICST49551.2021.%' THEN 'ICST'  -- 2021
    WHEN doi LIKE '10.1109/ICST46399.2020.%' THEN 'ICST'  -- 2020
    WHEN doi LIKE '10.1109/ICST.2019.%' THEN 'ICST'  -- 2019
    WHEN doi LIKE '10.1109/ICST.2018.%' THEN 'ICST'  -- 2018
    WHEN doi LIKE '10.1109/ICST.2017.%' THEN 'ICST'  -- 2017
    ...
    -- Index 13
    WHEN doi LIKE '10.1109/SCAM52516.2021.%' THEN 'SCAM'  -- 2021
    WHEN doi LIKE '10.1109/SCAM51674.2020.%' THEN 'SCAM'  -- 2020
    WHEN doi LIKE '10.1109/SCAM.2019.%' THEN 'SCAM'  -- 2019
    WHEN doi LIKE '10.1109/SCAM.2018.%' THEN 'SCAM'  -- 2018
    WHEN doi LIKE '10.1109/SCAM.2017.%' THEN 'SCAM'  -- 2017

    WHEN doi LIKE '10.1145/3486609.%' THEN 'GPCE'  -- 2021
    WHEN doi LIKE '10.1145/3425898.%' THEN 'GPCE'  -- 2020
    WHEN doi LIKE '10.1145/3357765.%' THEN 'GPCE'  -- 2019
    WHEN doi LIKE '10.1145/3278122.%' THEN 'GPCE'  -- 2018
    WHEN doi LIKE '10.1145/3136040.%' THEN 'GPCE'  -- 2017

    WHEN doi LIKE '10.1007/978-3-030-71500-7_%' THEN 'FASE'  -- 2021
    WHEN doi LIKE '10.1007/978-3-030-45234-6_%' THEN 'FASE'  -- 2020
    WHEN doi LIKE '10.1007/978-3-030-16722-6_%' THEN 'FASE'  -- 2019
    WHEN doi LIKE '10.1007/978-3-319-89363-1_%' THEN 'FASE'  -- 2018
    WHEN doi LIKE '10.1007/978-3-662-54494-5_%' THEN 'FASE'  -- 2017
